...
const MENU_ITEMS: NavItem[] = [
  ...
  { href: "/app/almacenes", label: "Almacenes", icon: Warehouse },
  { href: "/app/furgonetas", label: "Furgonetas", icon: Truck },
  { href: "/app/tableros-fisicos", label: "Tableros físicos", icon: Layers },
